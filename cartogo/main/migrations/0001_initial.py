# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-19 16:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fule_type', models.CharField(choices=[('D', 'DISEL'), ('P', 'PETROL'), ('CNG', 'CNG')], max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_type', models.CharField(choices=[('DL', 'Driving Licence'), ('PAN', 'PAN CARD'), ('VI', 'VOTER ID')], max_length=1)),
                ('doc_url', models.SlugField()),
            ],
        ),
        migrations.CreateModel(
            name='TransactinHistory',
            fields=[
                ('transaction_id', models.AutoField(primary_key=True, serialize=False)),
                ('payment', models.DecimalField(decimal_places=1, max_digits=3)),
                ('status', models.CharField(choices=[('S', 'Sucess'), ('F', 'Fail'), ('P', 'Pending')], max_length=1)),
                ('datetime', models.DateTimeField()),
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.BokingHistory')),
            ],
        ),
        migrations.AddField(
            model_name='company',
            name='doc_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Document123'),
        ),
        migrations.AddField(
            model_name='car',
            name='company',
